...
export const metadata: Metadata = {
	title: 'Artwork Guidelines | Ekse Print',
	description:
				...
				<div className='container mx-auto px-4'>
					<div className='mx-auto max-w-3xl text-center'>
						...
						<p className='text-lg text-neutral-300'>
							Follow these guidelines to ensure your artwork prints perfectly
						</p>
					</div>
				</div>
			</section>
				...
				<div className='container mx-auto px-4'>
					<div className='mb-12 text-center'>
						...
						<p className='mx-auto max-w-2xl text-lg text-muted-foreground'>
							Properly prepared artwork ensures the best print quality and helps
							us process your order faster.
						</p>
					</div>
					...
					<div className='mx-auto max-w-4xl'>
						<div className='mb-8 text-center'>
							...
							<p className='text-lg text-muted-foreground'>
								Additional recommendations for the best results
							</p>
						</div>
							...
							<CardContent className='flex items-start gap-4 pt-6'>
								...
								<div>
									...
									<p className='text-sm text-amber-800'>
										Ekse Print is not responsible for errors in
										customer-supplied artwork. Please carefully review your
										files before submission. We recommend requesting a proof
										before final printing for large orders.
									</p>
								</div>
							</CardContent>
						</Card>
				...
				<div className='container mx-auto px-4'>
					<div className='mx-auto max-w-2xl text-center'>
						...
						<p className='mb-8 text-neutral-300'>
							Our team can help you prepare your files for print. Contact us for
							design assistance or file preparation services.
						</p>
